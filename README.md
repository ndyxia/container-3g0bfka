...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3g0bfka.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3g0bfka.containers.anotherwebservice.com/
...
```
git clone git@github.com:ndyxia/container-3g0bfka.git
cd container-3g0bfka
```
...
```
docker attach container-3g0bfka
```
